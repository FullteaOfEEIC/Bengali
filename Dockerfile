...
RUN pip install numpy tensorflow-gpu==2.0.0 keras torch torchvision

RUN pip install opencv-python seaborn matplotlib tqdm jupyter pandas xlrd xgboost sklearn pyarrow
